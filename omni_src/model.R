...
myInputDataframe = datasheet(myScenario, name="helloworldOmni_InputDatasheetR")
...
saveDatasheet(myScenario, data=myOutputDataframe, name="helloworldOmni_OutputDatasheetR")
